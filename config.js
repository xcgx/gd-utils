...
const DEFAULT_TARGET = '1DMFoNjcoX_Z01u4_ojugQHgCvHaTe835' // 必填，拷贝默认目的地ID，如果不指定target，则会复制到此处，建议填写团队盘ID
...
const AUTH = { // 如果您拥有service account的json授权文件，可将其拷贝至 sa 目录中以代替 client_id/secret/refrest_token
  ...
  expires: 0, // 可以留空
  access_token: '', // 可以留空
  tg_token: '1152212327:AAHX1YFqM4bEllnpuxYZu770YggmS8L43YY', // 你的 telegram robot 的 token，获取方法参见 https://core.telegram.org/bots#6-botfather
  tg_whitelist: ['krisjess'] // 你的tg username(t.me/username)，bot只会执行这个列表里的用户所发送的指令
}
